...
CAKE.ConVars[ "Default_Money" ] = "1000"; -- How much money do the characters start out with.
CAKE.ConVars[ "Default_Title" ] = "Title1"; -- What is their title when they create their character.
...
CAKE.ConVars[ "Schema" ] = "void"; -- What folder is schema data being loaded from?
