...
CreateClientConVar( "oocred", 0, true, true )
CreateClientConVar( "oocblue", 0, true, true )
CreateClientConVar( "oocgreen", 255, true, true )
CreateClientConVar( "oocalpha", 100, true, true )
CreateClientConVar( "facetoggle", 1, true, true )
CreateClientConVar( "timetoggle", 0, true, true )
CreateClientConVar( "ooctoggle", 1, true, false )
...
if( LocalPlayer():GetInfo( "ooctoggle" ) == "1" ) then
