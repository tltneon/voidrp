...
function HolsterToggle( ply )
	...
	if( ply:GetNWBool( "holstered", false ) ) then
...
function NPCWeaponHook( ply, key )
...
NPCAnim.CitizenMaleAnim["meleeaimidle"] = "ACT_IDLE"
...
NPCAnim.CitizenMaleAnim["grenadefire"] = "ACT_IDLE"
 
NPCAnim.CitizenMaleAnim["slamidle"] = "ACT_IDLE"
NPCAnim.CitizenMaleAnim["slamwalk"] = "ACT_WALK"
NPCAnim.CitizenMaleAnim["slamrun"] = "ACT_RUN"
NPCAnim.CitizenMaleAnim["slamaimidle"] = "ACT_IDLE"
...
NPCAnim.CitizenMaleAnim["slamaimwalk"] = "ACT_WALK"
...
NPCAnim.CitizenFemaleAnim["meleeaimidle"] = "ACT_IDLE"
...
NPCAnim.CitizenFemaleAnim["grenadefire"] = "ACT_IDLE"
 
NPCAnim.CitizenFemaleAnim["slamidle"] = "ACT_IDLE"
NPCAnim.CitizenFemaleAnim["slamwalk"] = "ACT_WALK"
NPCAnim.CitizenFemaleAnim["slamrun"] = "ACT_RUN"
NPCAnim.CitizenFemaleAnim["slamaimidle"] = "ACT_IDLE"
...
NPCAnim.CitizenFemaleAnim["slamaimwalk"] = "ACT_WALK"
...
local function GetWeaponAct( ply, act )
	...
	if( weap:GetNWBool( "NPCAimed", true ) ) then
		if !table.HasValue( NeverAimed, weap:GetClass() ) then
			posttrans = "aim";	
		end
	else
	...
	if trans ~= nil and posttrans ~= nil then
		return trans .. posttrans
	else
		return ""
	end
...
function NPCAnim.SetPlayerAnimation( ply, weapanim )
	...
	if( ( weapanim == PLAYER_ATTACK1 or weapanim == PLAYER_RELOAD ) and weap:IsValid() ) then
		...
		if( weapanim == PLAYER_RELOAD ) then
			...
			if( string.find( seqname, "melee" ) or string.find( seqname, "grenade" ) or string.find( seqname, "slam" ) or string.find( string.lower( seqname ), "gesture" ) ) then
