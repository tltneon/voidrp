...
--Seemingly, the function's been changed, this doesn't work anymore.
...
function Admin_ExtraProps(ply, cmd, args)
	...
	CAKE.SendChat( target, "Your extra props has been set to " .. args[2] .. " by " .. ply:OOCName());
	CAKE.SendChat( ply, target:OOCName() .. "'s extra prop limit has been set to " .. args[2] );
...
function Admin_ExtraRagdolls(ply, cmd, args)
	...
	CAKE.SendChat( target, "Your extra ragdolls has been set to " .. args[2] .. " by " .. ply:OOCName());
	CAKE.SendChat( ply, target:OOCName() .. "'s extra ragdolls  has been set to " .. args[2] );
...
function Admin_ExtraVehicles(ply, cmd, args)
	...
	CAKE.SendChat( target, "Your extra vehicles has been set to " .. args[2] .. " by " .. ply:OOCName());
	CAKE.SendChat( ply, target:OOCName() .. "'s extra vehicle limit has been set to " .. args[2] );
...
function Admin_ExtraEffects(ply, cmd, args)
	...
	CAKE.SendChat( target, "Your extra effects has been set to " .. args[2] .. " by " .. ply:OOCName());
	CAKE.SendChat( ply, target:OOCName() .. "'s extra effects limit has been set to " .. args[2] );
	
end

function PLUGIN.Init()

	CAKE.ConVars[ "Default_Extraprops" ] = 90;
	CAKE.ConVars[ "Default_Extraragdolls" ] = 9;
	CAKE.ConVars[ "Default_Extravehicles" ] = 0;
	CAKE.ConVars[ "Default_Extraeffects" ] = 9;
	
	CAKE.ConVars[ "PropLimit" ] = 150;
	CAKE.ConVars[ "RagdollLimit" ] = 10;
	CAKE.ConVars[ "VehicleLimit" ] = 0;
	CAKE.ConVars[ "EffectLimit" ] = 10;
	...
	CAKE.AdminCommand( "extraprops", Admin_ExtraProps, "Change someones extra props limit", true, true, false );
	CAKE.AdminCommand( "extraragdolls", Admin_ExtraRagdolls, "Change someones extra ragdolls limit", true, true, false );
	CAKE.AdminCommand( "extravehicles", Admin_ExtraVehicles, "Change someones extra vehicles limit", true, true, false );
	CAKE.AdminCommand( "extraeffects", Admin_ExtraEffects, "Change someones extra effects limit", true, true, false );
